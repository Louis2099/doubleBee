...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # RESTORED to mdp.last_action (model_3500_params/env.yaml shows the
        # actions term with params={}). action_history(1) is numerically
        # identical, but this is the exact call that run used.
